...
const CONTEXT_CONTRIBUTION: Record<string, string[]> = {
  'react': ['framework', 'ui_library', 'state'],
  'next': ['framework', 'backend', 'runtime', 'hosting', 'api'],
  'svelte': ['framework', 'ui_library', 'state'],
  'vue': ['framework', 'ui_library', 'state'],
  'vite': ['build', 'pkg_manager'],
  'typescript': ['main_language', 'type_system'],
  'n8n': ['automation_platform', 'workflow_engine', 'integration_layer', 'api_orchestration'],
  '@supabase/supabase-js': ['db', 'backend', 'api'],
  'prisma': ['db', 'orm'],
  '@vercel/node': ['runtime', 'hosting'],
  'astro': ['framework', 'build', 'hosting'],
