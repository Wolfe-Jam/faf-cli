...
export const FORMAT_PYRAMID = {
  // 🔺 LEVEL 0 - THE TRUE APEX - TURBO-CAT SITS HERE! 😽
  turbo_cat: '😽 TURBO-CAT',  // The catalyst that processes all below!

  // 🔺 LEVEL 1 - THE FOUNDATION STONE (1 format) - The Most Sacred Format
  level_1: [
    '.faf'  // The ONE format that started it all!
  ],

  // 🔺 LEVEL 2 - DUAL PILLARS (2 formats) - Package Management Kings
  level_2: [
    'package.json',      // JavaScript/Node ecosystem
    'requirements.txt'   // Python ecosystem
  ],

  // 🔺 LEVEL 3 - THE TRINITY (3 formats) - Language Foundations
  level_3: [
    'Cargo.toml',        // Rust
    'go.mod',            // Go
    'pom.xml'            // Java/Maven
  ...
  // 🔺 LEVEL 4 - FOUR CORNERS (4 formats) - Modern Package Managers
  level_4: [
  ...
  // 🔺 LEVEL 5 - PENTAGRAM (5 formats) - Framework Configs
  level_5: [
  ...
  // 🔺 LEVEL 6 - HEXAGON (6 formats) - Build Tools
  level_6: [
  ...
  // 🔺 LEVEL 7 - SACRED SEVEN (7 formats) - Cloud & Deployment
  level_7: [
    'Dockerfile',        // Docker
  ...
  // 🔺 LEVEL 8 - OCTAGON (8 formats) - CI/CD & Testing
  level_8: [
  ...
  // 🔺 LEVEL 9 - ENNEAD (9 formats) - Database & ORM
  level_9: [
  ...
  // 🔺 LEVEL 10 - DECIMAL (10 formats) - Modern Frameworks Extended
  level_10: [
  ...
  // 🔺 LEVEL 11 - ELEVEN (11 formats) - Mobile & Desktop
  level_11: [
  ...
  // 🔺 LEVEL 12 - DOZEN (12 formats) - API & Backend
  level_12: [
  ...
  // 🔺 LEVEL 13 - THIRTEEN (13 formats) - Styling & UI
  level_13: [
  ...
  // 🔺 LEVEL 14 - FOURTEEN (14 formats) - Monorepo & Tooling
  level_14: [
    'lerna.json',        // Lerna
    'nx.json',           // Nx
    'rush.json',         // Rush
  ...
  // 🔺 LEVEL 15 - FIFTEEN (15 formats) - Linting & Quality
  level_15: [
    '.eslintrc.js',      // ESLint
    '.prettierrc',       // Prettier
    'biome.json',        // Biome
  ...
  // 🔺 LEVEL 16 - SIXTEEN (16 formats) - File Extensions
  level_16: [
    '*.ts',              // TypeScript
  ...
  // 🔺 LEVEL 17 - THE BASE (17 formats) - Infrastructure & Misc
  level_17: [
